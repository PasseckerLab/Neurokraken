...
class Millis():
    ...
    def zero(self):
        """reset the timer's current time to 0"""
        self.t_start = get.time_ms
    
    def set(self, new_time_ms):
        """
        set the current time to a specific value - time will keep counting up from thereon
        ...
        """
        self.t_start = get.time_ms - new_time_ms
